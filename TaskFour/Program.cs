// считывает с консоли числа (по одному в строке) до тех пор, пока сумма введённых чисел
...
Console.Write("Сумма квадратов введеных чисел равна: "+rezalt);
